...
{
	static const RAPI::INPUT_ELEMENT_DESC INPUT_LAYOUT_DESC[5]; 
...
__declspec(selectany) const RAPI::INPUT_ELEMENT_DESC ExVertexStruct::INPUT_LAYOUT_DESC[5] =
{
	...
	{ "TEXCOORD", 1, RAPI::FORMAT_R32G32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
...
{
	static const RAPI::INPUT_ELEMENT_DESC INPUT_LAYOUT_DESC[6]; 
...
__declspec(selectany) const RAPI::INPUT_ELEMENT_DESC ExTVertexStruct::INPUT_LAYOUT_DESC[6] =
{
	{ "POSITION", 0, RAPI::FORMAT_R32G32B32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "NORMAL", 0, RAPI::FORMAT_R32G32B32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD", 0, RAPI::FORMAT_R32G32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD", 1, RAPI::FORMAT_R32G32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "DIFFUSE", 0, RAPI::FORMAT_R8G8B8A8_UNORM, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "TANGENT", 0, RAPI::FORMAT_R32G32B32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
};
...
__declspec(selectany) const RAPI::INPUT_ELEMENT_DESC ExTVertexStructInstanced::INPUT_LAYOUT_DESC[9] =
{
	{ "POSITION", 0, RAPI::FORMAT_R32G32B32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "NORMAL", 0, RAPI::FORMAT_R32G32B32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD", 0, RAPI::FORMAT_R32G32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	...
	{ "DIFFUSE", 0, RAPI::FORMAT_R8G8B8A8_UNORM, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "TANGENT", 0, RAPI::FORMAT_R32G32B32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "INSTANCE_POSITION", 0, RAPI::FORMAT_R32G32B32_FLOAT, 1, 0xFFFFFFFF, RAPI::INPUT_PER_INSTANCE_DATA, 1},
	{ "INSTANCE_COLOR", 0, RAPI::FORMAT_R8G8B8A8_UNORM, 1, 0xFFFFFFFF, RAPI::INPUT_PER_INSTANCE_DATA, 1 },
	{ "INSTANCE_ROTATION", 0, RAPI::FORMAT_R32G32B32A32_FLOAT, 1, 0xFFFFFFFF, RAPI::INPUT_PER_INSTANCE_DATA, 1 },
};

struct ExTSkelVertexStruct : public ExTVertexStruct
{
	static const RAPI::INPUT_ELEMENT_DESC INPUT_LAYOUT_DESC[15];
...
__declspec(selectany) const RAPI::INPUT_ELEMENT_DESC ExTSkelVertexStruct::INPUT_LAYOUT_DESC[15] =
{
	{ "POSITION", 0, RAPI::FORMAT_R32G32B32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "NORMAL", 0, RAPI::FORMAT_R32G32B32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD", 0, RAPI::FORMAT_R32G32_FLOAT, 0, 0xFFFFFFFF, RAPI::INPUT_PER_VERTEX_DATA, 0 },
